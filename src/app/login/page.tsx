...
export default function LoginPage() {
  ...
  // OAuth buttons flip light/dark with the active theme so all primary actions
  // share the same color treatment. Brand logos keep their own colors.
  const oauthBtn =
    theme === 'dark'
      ...
      <div className="w-full max-w-sm">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className={`w-full py-2.5 text-sm font-medium rounded-lg disabled:opacity-50 transition-colors ${oauthBtn}`}
          >
        ...
        <div className="mt-6 grid gap-2.5">
          <button
            ...
            className={`w-full inline-flex items-center justify-center gap-2.5 py-2.5 rounded-lg text-sm font-medium transition-colors ${oauthBtn}`}
          >
