...
export default function SleepPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b] text-white relative overflow-hidden">
      ...
      {/* Moon glow */}
      <div className="fixed top-1/4 right-1/4 w-96 h-96 rounded-full bg-purple-500/10 blur-[120px] pointer-events-none" />
      <div className="fixed bottom-1/4 left-1/4 w-96 h-96 rounded-full bg-indigo-500/10 blur-[120px] pointer-events-none" />
      ...
      <div className="relative z-10 pt-24 pb-32 px-4 sm:px-6 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-white/[0.04] border border-white/[0.08] mb-5">
            ...
            <span className="text-xs text-zinc-400">Ethan&apos;s Blog · Sleep</span>
          </div>
          <h1 className="text-5xl md:text-7xl font-bold tracking-tight leading-[0.9]">
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-300 to-indigo-300">Drift</span>
          ...
          {filtered.map(item => {
            ...
            return (
              ...
              >
                ...
                {/* Type badge */}
                <div className="absolute top-3 left-3 px-2 py-0.5 rounded-full bg-black/40 backdrop-blur-sm text-[10px] uppercase tracking-wider text-white">
                  {item.type}
                </div>
                ...
                {isCurrent && (
                  <div className="absolute top-3 right-3 flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-purple-500/30 backdrop-blur-sm">
                    <div className="w-1.5 h-1.5 rounded-full bg-purple-400 animate-pulse" />
                    <span className="text-[10px] text-purple-200">Playing</span>
                  </div>
                )}
                {/* Info */}
                <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/80 to-transparent">
                  <p className="text-white font-medium text-sm text-left">{item.title}</p>
                  <p className="text-zinc-400 text-xs mt-0.5 text-left">
      ...
      <AnimatePresence>
        {nowPlaying && (
          ...
          >
            <div className="glass-nav-acrylic rounded-2xl p-4 backdrop-blur-2xl bg-[#0a0a0b]/80 border border-white/[0.08] shadow-2xl shadow-black/40">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  onClick={togglePlay}
                  className="w-10 h-10 flex-shrink-0 rounded-full bg-purple-500 hover:bg-purple-400 flex items-center justify-center text-white transition-colors"
                >
                  {isPlaying ? (
              ...
              <div className="flex items-center gap-2 mt-3 pt-3 border-t border-white/[0.06]">
                ...
                <div className="flex items-center gap-1 ml-auto">
                  <span className="text-[10px] uppercase tracking-wider text-zinc-500">Sleep</span>
