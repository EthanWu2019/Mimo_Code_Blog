...
interface Episode {
  id: number; number: number; title: string; duration: string;
}

export default function FloatingPlayer({ episode, isPlaying, onTogglePlay }: {
  episode: Episode; isPlaying: boolean; onTogglePlay: () => void;
}) {
      ...
      {expanded ? (
        <div className="p-4">
          ...
          <div className="flex items-center gap-2 mb-3">
            ...
            <span className="text-[10px] text-zinc-400 dark:text-white/30 tabular-nums">{episode.duration}</span>
          </div>
