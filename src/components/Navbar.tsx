          ...
          <div className="flex items-center gap-1">
            <nav className="hidden sm:flex items-center gap-1">
              ...
              <button
                ...
                className="ml-1 w-9 h-9 flex items-center justify-center rounded-lg hover:bg-zinc-100 dark:hover:bg-zinc-800 transition-colors"
              >
                {/* Container: 5x5, explicit transform-origin so each child
                    rotates around its own center. Two icons stack with
                    absolute positioning; only one is visible at a time.
                    We animate a single property (transform) so the
                    browser doesn't have to coordinate a 'transition-all'
                    cascade across rotate/scale/opacity, which previously
                    produced a 'jumbled' multi-axis spin when the icon
                    shapes themselves weren't perfectly centred. */}
                <span className="relative inline-block w-5 h-5" style={{ transformOrigin: '50% 50%' }}>
                  <svg
                    aria-hidden
                    viewBox="0 0 24 24"
                    fill="none"
                    ...
                    className={`absolute inset-0 w-5 h-5 text-amber-500 transition-transform duration-300 ease-out ${
                  ...
                  <svg
                    ...
                    strokeLinecap="round"
                    strokeLinejoin="round"
                    className={`absolute inset-0 w-5 h-5 text-zinc-400 transition-transform duration-300 ease-out ${
